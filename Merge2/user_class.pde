//User class that stores everything we need
class User {
  int user_id;
  String first_name;
  String last_name;
  ...
  User(int user_id, String first_name, String last_name, String email,String pseudo, String password ,int age, String address, String phone_num, JSONArray favorites) {
