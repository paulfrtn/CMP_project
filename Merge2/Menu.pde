    ...
    if(MENU)
    {
      ...
      else 
      {
       ...
       //dark mode
        ...
        else if((mouseX > 20 && mouseX < 40 && mouseY > 10 && mouseY < 40) || (mouseX >= 160 && mouseX <= 190 && mouseY >= 10 && mouseY <= 40) || (mouseX >= 300 && mouseX <= 330 && mouseY >= 10 && mouseY <= 40) || (mouseX >= 430 && mouseX <= 460 && mouseY >= 10 && mouseY <= 40))
        {
          cursor(HAND);
        }
        else
